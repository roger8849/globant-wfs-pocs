package com.globant.sample.tests.e2e.cucumber.api.definitions;

import com.globant.sample.tests.e2e.cucumber.api.models.HateOasResource;
import com.globant.sample.tests.e2e.cucumber.api.models.Sample;
...
public class SamplesApiDefinitions extends AbstractApiDefinitions {
    ...
    public void iShouldSeeSamplesInTheResponse(int count) throws Throwable {
        assertNotNull("Samples", samples);
        Assert.assertEquals("Expected number of samples did not match", count, samples.embedded.get("samples").size());
    }
